...
const AboutPage: React.FC = () => {
  return (
    <div className="container mx-auto p-4 sm:p-6 md:p-8 max-w-3xl bg-white shadow-xl rounded-xl my-8">
      {/* Fix: Use text-brand-teal for consistency */}
      <h2 className="text-3xl font-bold text-center text-brand-teal mb-8">About Free The Bladder</h2>
      ...
      <div className="prose prose-lg sm:prose-xl max-w-none text-slate-700 leading-relaxed">
        ...
        {/* Fix: Use text-brand-teal for consistency */}
        <p className="mt-6 text-2xl sm:text-3xl text-center font-bold text-brand-teal py-4">
      ...
      <div className="mt-12 pt-8 border-t border-slate-200">
        {/* Fix: Use text-brand-teal for consistency */}
        <h3 className="text-2xl font-semibold text-center text-brand-teal mb-6">Connect with Us</h3>
