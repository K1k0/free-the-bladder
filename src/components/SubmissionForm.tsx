      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-3">
            <div className="flex items-center">
                <input id="isStepFree" name="isStepFree" type="checkbox" checked={formData.isStepFree ?? false} onChange={handleChange} className={checkboxClasses}/>
                <label htmlFor="isStepFree" className="ml-2 block text-sm text-slate-800">Step-free access</label>
            </div>
            <div className="flex items-center">
                <input id="is24Hour" name="is24Hour" type="checkbox" checked={formData.is24Hour ?? false} onChange={handleChange} className={checkboxClasses}/>
