...
const Navbar: React.FC<NavbarProps> = ({ currentView, onNavigate }) => {
  ...
  return (
    <nav className="bg-[#368282] p-4 shadow-lg sticky top-0 z-50">
        ...
        <div className="flex flex-wrap justify-center gap-2">
          {navItems.map((item) => (
            <button
              ...
              className={`flex items-center px-3 py-2 text-sm sm:text-base rounded-t-md font-medium transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#368282] focus:ring-white
